...
This file is historical release documentation. Its Phase 1 wording and release-candidate claims are preserved for traceability, not as the current product contract.

Canonical project entry point: [current README](../../README.md).
